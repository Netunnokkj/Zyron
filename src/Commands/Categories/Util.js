      ...
      try {
       ...
       Collector.on('collect', async (i) => {
         ...
         if (i.customId === 'serverinfo:button:maisdetalhes') {
          ...
          let verificationLevel = await Guild.verificationLevel.replaceAll('0', 'Nenhum').replaceAll('1', 'Baixo').replaceAll('2', 'Médio').replaceAll('3', 'Alta').replaceAll('4', 'Mais alta');
